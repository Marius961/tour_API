        ...
        http
                ...
                .and()
                    ...
                    .authorizeRequests()
                        ...
                        .antMatchers(HttpMethod.GET,"/api/reservations/*", "/api/auth/user-data").hasAuthority(Role.USER.getAuthority())
                        .antMatchers(HttpMethod.GET, "/img/**", "/api/tours/*","/api/hotel", "/api/hotel/*").permitAll()
                        .antMatchers(HttpMethod.POST,"/api/reservations", "/api/auth/change-password", "/api/auth/update-user-data").hasAuthority(Role.USER.getAuthority())
                        .antMatchers(HttpMethod.POST,"/api/reservations/cancel/{id}").hasAuthority(Role.ADMIN.getAuthority())
                        .antMatchers("/api/tours/**", "/api/hotel/**", "/api/reservations/**", "/api/admin/**").hasAuthority(Role.ADMIN.getAuthority())
