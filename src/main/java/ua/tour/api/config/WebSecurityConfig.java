        ...
        http
                ...
                .and()
                    ...
                    .authorizeRequests()
                        ...
                        .antMatchers(HttpMethod.GET,"/api/tours/*", "/api/hotel/*").hasAuthority(Role.USER.getAuthority())
                        .antMatchers("/api/tours/**", "/api/hotel/**").hasAuthority(Role.ADMIN.getAuthority())
