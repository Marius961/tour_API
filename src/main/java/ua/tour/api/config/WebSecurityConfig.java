        ...
        http
                ...
                .and()
                    ...
                    .authorizeRequests()
                        ...
                        .antMatchers(HttpMethod.GET,"/api/tours/*", "/api/hotel/*", "/api/reservations").hasAuthority(Role.USER.getAuthority())
                        ...
                        .antMatchers("/api/tours/**", "/api/hotel/**", "/api/reservations/**").hasAuthority(Role.ADMIN.getAuthority())
